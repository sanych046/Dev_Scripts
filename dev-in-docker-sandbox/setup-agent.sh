...
# --- Install SDKMAN! (Java 21, 25, Maven, Gradle) ---
...
ENV PATH="/home/developer/.sdkman/candidates/java/current/bin:\\
/home/developer/.sdkman/candidates/maven/current/bin:\\
/home/developer/.sdkman/candidates/gradle/current/bin:\\
/home/developer/.nvm/versions/node/v20.11.1/bin:\\
\${PATH}"
...
4. INSTALLED TOOLS
   - JAVA (21/25), NODE (20), PYTHON, GO, RUST, MAVEN, GRADLE.
EOF
